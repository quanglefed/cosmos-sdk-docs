...
⚠️ **DEPRECATED**: Gói này đã bị deprecate và sẽ bị loại bỏ trong bản phát hành major tiếp theo. Module `x/group` sẽ được chuyển sang repo riêng `github.com/cosmos/cosmos-sdk-legacy`.
